import { TeamAccountsRoutingModule } from './teamaccounts-routing.module';
...
@NgModule({
  declarations: [TeamAccountsComponent],
  imports: [
    CommonModule,
    TeamAccountsRoutingModule,
    FlexLayoutModule,
    MatInputModule,
    MatIconModule,
    MatButtonModule,
...
export class TeamAccountsModule {
}
