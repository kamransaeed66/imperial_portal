...
import { WorkersDashboardRoutingModule } from './workers-dashboard-routing.module';
...
import { WorkerJobTableComponent } from './worker-job-table/worker-job-table.component';
...
@NgModule({
  declarations: [WorkersDashboardComponent, WorkerJobTableComponent ],
  imports: [
    CommonModule,
    WorkersDashboardRoutingModule,
    FlexLayoutModule,
    ChartModule,
    MatIconModule,
...
export class WorkersDashboardModule {
}
